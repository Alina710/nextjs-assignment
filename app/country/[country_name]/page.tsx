...
<div className="bg-white shadow-md rounded-lg p-6 max-w-md w-full">
        ...
        height={60} 
          className="mb-4" 
        />
        <h1 className ="text-3xl font-bold text-center mb-4">    {country.name}</h1>
        <p className="mt-2 text-lg"><strong>Population:</strong>  {country.population} </p>
        <p       className="mt-2 text-lg"><strong>Capital:</strong> {country.capital}   </p>
        <p className="mt-2 text-lg"><strong>Language:</strong> {country.language}</p>
        <p        className="mt-2 text-lg"><strong>Currency:</strong> {country.currency}</p>
